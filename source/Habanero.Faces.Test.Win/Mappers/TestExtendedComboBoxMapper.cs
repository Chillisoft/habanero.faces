...
//            Assert.AreSame(extendedComboBox.ComboBox, lookupComboBoxMapper.Control);
    ...
    class ExtendedComboBoxMapperSpy : ExtendedComboBoxMapper
    {
        ...
        public IBOGridAndEditorControl CallGetIBOGridAndEditorControl()
        {
            return this.GetIBOGridAndEditorControl();
        }
    }
}
