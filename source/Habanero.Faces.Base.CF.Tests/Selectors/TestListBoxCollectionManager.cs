...
namespace Habanero.Faces.Test.Base.Controllers
{
    public abstract class TestListBoxCollectionManager
    {
        ...
        public void TestCreateTestListBoxCollectionController()
        {
            ...
            ListBox cmb = GetControlFactory().CreateListBox();
        ...
        {
            //---------------Set up test pack-------------------
            ListBox listBox = GetControlFactory().CreateListBox();
            //---------------Execute Test ----------------------
        ...
        protected static ListBoxCollectionManager CreateListBoxCollectionManager(ListBox listBox)
        {
