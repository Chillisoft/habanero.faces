...
/*//TODO brett 21 Apr 2011: CF
        ...
        private static RelationshipDefCol CreateRelationshipDefCol(IPropDefCol lPropDefCol)
        {
            ...
            relDef = new SingleRelationshipDef("Engine", typeof(Engine), relKeyDef, false, DeleteParentAction.DereferenceRelated) { OwningBOHasForeignKey = false };
            relDefCol.Add(relDef);*/
            return relDefCol;
        }
        ...
        private static PropDefCol CreateBOPropDef()
        {
            PropDefCol lPropDefCol = new PropDefCol
                 {
                     new PropDef("CarID", typeof (Guid), PropReadWriteRule.WriteOnce, "CAR_ID",
                                 null),
                     new PropDef("CarRegNo", typeof (String), PropReadWriteRule.ReadWrite,
                                 "CAR_REG_NO", null)
                 };
/*//TODO brett 21 Apr 2011: CF
