...
{
    /// <summary>
    /// Manages a collection of mappers that are sub-types of <see cref="IControlMapper"/>
    /// </summary>
    public class ControlMapperCollection : List<IControlMapper>, IControlMapperCollection
    {
        ...
        {
            get { return this.FirstOrDefault(controlMapper => controlMapper.PropertyName == propertyName); }
        }


        public new IControlMapper Add(IControlMapper mapper)
        {
            base.Add(mapper);
            return mapper;
        }
        ...
        public IBusinessObject BusinessObject
        {
            ...
            set
            {
                foreach (var controlMapper in this)
                {
