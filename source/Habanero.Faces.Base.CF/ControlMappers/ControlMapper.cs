...
namespace Habanero.Faces.Base
{
    ...
    /// order to display and capture information for an individual property
    /// of a Business Object. Think of the Control Mappers as Binding on Steriods. 
    /// </summary>
    public abstract class ControlMapper : IControlMapper
    {
        ...
        public virtual void UpdateControlValueFromBusinessObject()
        {
            ...
            catch (Exception e)
            {
                ...
                var exception = new HabaneroApplicationException(message, e);
                throw exception;
            }
        }
        ...
        {
            var mapperStrategy = ControlFactory.CreateControlMapperStrategy();
        ...
        protected virtual void UpdateIsEditable()
        {
            ...
            this.ControlEnabled = IsEditable;
        }
        /// <summary>
        ...
        /// <summary>
        /// Update the Visual state of the control so as to differentiate between
        /// Editable and none editable controls.
        /// </summary>
        ...
        public static IControlMapper Create(Type mapperType, Control ctl, string propertyName, bool isReadOnly, IControlFactory controlFactory)
        {
            ...
            else
            {
                throw new UnknownTypeNameException
                    ("The control mapper " + "type '" + mapperType.Name + "' was not found.  All control "
