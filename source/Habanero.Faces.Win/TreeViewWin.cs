...
namespace Habanero.Faces.Win
{
    ...
    public class TreeViewWin : TreeView, ITreeView
    {
        ...
        #region Double Click Supression

        private bool _suppressDoubleClickEvent;


        protected override void WndProc(ref Message m)
        {
            // Suppress WM_LBUTTONDBLCLK if needed
            if (_suppressDoubleClickEvent && m.Msg == 0x203) m.Result = IntPtr.Zero;
        ...
        /// </summary>
        public bool SuppressDoubleClickEvent
        {
            get { return _suppressDoubleClickEvent; }
            set { _suppressDoubleClickEvent = value; }
        }
