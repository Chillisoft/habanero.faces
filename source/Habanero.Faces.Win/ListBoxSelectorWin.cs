...
namespace Habanero.Faces.Win
{
    ...
    public class ListBoxSelectorWin : ListBoxWin, IBOListBoxSelector
    {
        ...
        /// <summary>
        /// Gets and Sets the business object collection displayed in the ListBox.
        /// </summary>
        public IBusinessObjectCollection BusinessObjectCollection
        {
            get { return _manager.BusinessObjectCollection; }
            set { _manager.BusinessObjectCollection = value; }
        }
