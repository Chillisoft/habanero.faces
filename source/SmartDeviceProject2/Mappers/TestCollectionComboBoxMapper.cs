...
//            Dictionary<string, string> collection = Sample.BOLookupCollection;
        ...
        public void TestSetBOCollection()
        {
            ...
            MyBO bo = new MyBO();
            IBusinessObjectCollection col = new BusinessObjectCollection<MyBO> { bo };
            //---------------Assert Precondition ---------------
...
/*        [Test]
        ...
        private CollectionComboBoxMapper CreateCollectionComboBoxMapper(ComboBox cmbox, string propName)
        {
