...
namespace Habanero.Faces.Base
{
    ...
    public class GridBaseManager
    {
        ...
        protected DataView GetDataTable(IBusinessObjectCollection boCol)
        {
            ...
            DataTable dataTable = DataSetProvider.GetDataTable(uiDef.UIGrid);
...
//                    if (_gridBase.Rows[i].Selected) rownum = i;
        ...
        {
            object idValue = dataRowView.Row[DataSetProvider.IDColumnName];
            Guid result;
        ...
        public void ApplySearch(IFilterClause searchClause, string orderBy)
        {
            ...
            IBusinessObjectCollection collection = BORegistry.DataAccessor.BusinessObjectLoader.
               GetBusinessObjectCollection(ClassDef, filterClauseString, orderBy);
            SetBusinessObjectCollection(collection);
        }
        /// <summary>
