    ...
    public class ReadOnlyGridControlManager
    {
        ...
        public void RefreshFilter()
        {
            try
            {
                ...
                {
                    string searchClause = GridControl.FilterControl.GetFilterClause().GetFilterClauseString("%", "'");
#pragma warning disable 612,618
                    //Temp need to support backward compatibility of the search criteria
                    if (!string.IsNullOrEmpty(GridControl.AdditionalSearchCriteria))
...
#pragma warning restore 612,618
                    GridControl.Grid.ApplySearch(searchClause, this.GridControl.OrderBy);
        ...
        public void SetBusinessObjectCollection(IBusinessObjectCollection boCollection)
        {
            ...
            if (this.GridControl.ClassDef == null)
            {
