...
namespace Habanero.Faces.Base
{
    ...
    public interface IGridControl : IBOSelectorAndEditor 
    {
        ...
        /// by the FilterControl. This is obsolete please use the <see cref="IFilterControl.AddStaticStringFilterClause"/>
        /// that achieves the same objective in a more standardised manner and will work correctly when the grid 
        /// is in <see cref="FilterModes.Search"/> and in <see cref="FilterModes.Filter"/>.
        /// </summary>
        [Obsolete("Please use the FilterControl.AddStaticStringFilterClause")]
