...
namespace Habanero.Faces.CF.Controls
{
    ...
    /// </summary>
    public class ControlCollectionCF : IControlCollection
    {
        private readonly Control.ControlCollection _col;

        ///<summary>
        /// Constructor for <see cref="ControlCollectionCF"/>
        ///</summary>
        ///<param name="col"></param>
        public ControlCollectionCF(Control.ControlCollection col)
        {
            _col = col;
        }
