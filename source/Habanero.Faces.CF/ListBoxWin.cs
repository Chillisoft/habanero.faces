...
namespace Habanero.Faces.Win
{
    ...
    /// </summary>
    public class ListBoxWin : ListBox, IListBox
    {
...
//        private string _errorMessage;
        ...
        /// </summary>
        public new ISelectedObjectCollection SelectedItems
        {
        ...
        /// <summary>
        /// Represents the collection of items in a ListBox. This is an adapter class
        /// which simply wraps the Windows ObjectCollection (ListBox.Items)
        /// </summary>
        public class ListBoxObjectCollectionWin : IListBoxObjectCollection
        {
            ...
            public void Insert(int index, object businessObject)
            {
                _items.Insert(index, businessObject);
            }
        ...
        /// This adapts the WinForms SelectedObjectCollection for Habanero.Faces
        /// </summary>
        public class ListBoxSelectedObjectCollectionWin : ISelectedObjectCollection
        {
            ...
            {
                return _items.Contains(selectedObject);
            }
