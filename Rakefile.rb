...
#------------------------dependency settings---------------------
$habanero_version = 'branches/v2.5-QIMDSS'
require 'rake-habanero.rb'

$smooth_version = 'branches/v1.4'
require 'rake-smooth.rb'

#------------------------project settings------------------------
$basepath = 'http://delicious:8080/svn/habanero/HabaneroCommunity/Faces/branches/v2.6-QIMDSS'
