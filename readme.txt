...
This package contains the binaries that comprise Habanero Faces, a UI library for use with Habanero Core that supports Windows forms and Visual WebGUI (an ajax library) development. It includes the following:

Habanero.Faces.Base.dll - core functionality shared by Win and VWG
